...
- Build an intervention component that renders `decision`, `findings`, `masked_preview`, `policy_version`, and `dlp_token`, then lets a user review or resubmit a WARN or MASK result.
